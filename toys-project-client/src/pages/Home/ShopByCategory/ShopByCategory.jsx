  ...
  return (
    <Container className="text-center mt-5 mb-5">
      ...
      <p className="text-center fw-semibold mb-5">
        Find your favorite toys here
      </p>

      <div className="d-flex justify-content-center gap-5">
        <button
          onClick={() => handleTabClick("teddy")}
          className={`px-4 py-2 borders rounded fw-bold ${
            activeTab == "teddy" ? " bg-info text-black" : ""
          }`}
        >
          Teddy
        </button>
        <button
          ...
          className={`px-4 py-2 borders rounded fw-bold ${
            activeTab == "dog" ? " bg-info text-black" : ""
          }`}
        >
          Dog
        </button>
        <button
          ...
          className={`px-4 py-2 borders rounded fw-bold ${
            activeTab == "cat" ? " bg-info text-black" : ""
          }`}
        >
          Cat
        </button>
